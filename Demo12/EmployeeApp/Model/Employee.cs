...
namespace EmployeeApp.Model
{
    ...
    public class EmployeeViewModel
    {
        ...
        {
            employees.Add(new Employee { ID = "1001", Firstname = "Yo", Lastname = "Lo", JobTitle = "Account Executive", Image = "Assets/Images/employee01.png" });
            employees.Add(new Employee { ID = "1002", Firstname = "Van", Lastname = "Mainen", JobTitle = "Actuary", Image = "Assets/Images/employee02.png" });
            employees.Add(new Employee { ID = "1003", Firstname = "Ossi", Lastname = "Kuningas", JobTitle = "VP Sales", Image = "Assets/Images/employee03.png" });
